...
export const techInfo: Tech[] = [
    ...
    { src: "python", name: "Python", desc: "Server-side development and automation scripting.", level: 5, category: "Backend" },
    ...
    { src: "git", name: "Git", desc: "Version control and collaborative development workflows.", level: 5, category: "Tools" },
    { src: "vscode", name: "VS Code", desc: "Primary code editor with advanced extensions and customizations.", level: 5, category: "Tools" },
    { src: "docker", name: "Docker", desc: "Used for deployments and containerization", level: 4, category: "Tools" },
    { src: "kubernetes", name: "K8s/Helm", desc: "Used for umbrella charts and packaged deployments combined", level: 4, category: "Tools" },
